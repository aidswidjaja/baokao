...
try {
    ...
    <br><br>
    <p>Due to technical limitations, only files shared with everyone can be edited on baokao. If editing or suggesting isn't working, try opening the file externally in Google Drive.</p>
    </div>
    <hr>
